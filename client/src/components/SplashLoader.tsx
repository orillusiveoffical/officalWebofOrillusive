...
export const SplashLoader: React.FC<SplashLoaderProps> = ({ onComplete }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 bg-[#111111] flex flex-col items-center justify-center text-[#F7F7F5]"
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="relative size-24 rounded-full overflow-hidden border border-white/10 shadow-2xl">
            <img
              src="/logo.jpg"
              alt="Orillusive Logo"
        ...
        <div className="mt-10 w-64 h-[2px] overflow-hidden bg-white/10 rounded-full">
          <motion.div
            initial={{ width: "0%" }}
            animate={{ width: "100%" }}
