...
export const ProcessSection: React.FC = () => {
  ...
  return (
    <section 
      ...
      className="py-36 md:py-52 lg:py-60 px-6 sm:px-12 lg:px-20 border-t border-black/5 bg-white overflow-hidden"
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <div 
          className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 relative" 
          role="tablist" 
          ...
          {PROCESS_STEPS.map((step, idx) => {
            ...
            return (
              <motion.button
                ...
                className={`text-left p-6 sm:p-7 rounded-3xl border transition-all duration-300 flex flex-col justify-between min-h-[220px] focus-visible:ring-2 focus-visible:ring-[#4F6B85] focus-visible:outline-none ${
                  isActive 
              ...
              >
                <div className="space-y-4">
                  <span className="font-mono text-2xl font-bold text-[#4F6B85]">
                    {step.step}
                  </span>
