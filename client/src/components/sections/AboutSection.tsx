...
export const AboutSection: React.FC = () => {
  return (
    <section 
      ...
      className="py-36 md:py-52 lg:py-60 px-8 sm:px-14 lg:px-24 border-t border-black/5 bg-white overflow-hidden"
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="grid gap-20 lg:grid-cols-2 lg:gap-28 items-start">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl leading-relaxed text-[#555555]">
          ...
          <motion.div 
            ...
            className="space-y-12 pl-0 lg:pl-16 border-l-0 lg:border-l border-black/10"
          >
            
            <div className="relative pl-8 border-l-2 border-[#4F6B85]">
              <div className="absolute -left-[7px] top-1.5 size-3 rounded-full bg-[#4F6B85]" aria-hidden="true" />
              <h3 className="text-lg font-bold uppercase tracking-wider text-[#111111]">Long-Term Product Mindset</h3>
              <p className="mt-4 text-xs sm:text-sm md:text-base leading-relaxed text-[#555555]">
            ...
            <div className="relative pl-8 border-l-2 border-black/15">
              <div className="absolute -left-[7px] top-1.5 size-3 rounded-full bg-black/30" aria-hidden="true" />
              <h3 className="text-lg font-bold uppercase tracking-wider text-[#111111]">Direct Senior Engineering</h3>
              <p className="mt-4 text-xs sm:text-sm md:text-base leading-relaxed text-[#555555]">
            ...
            <div className="relative pl-8 border-l-2 border-black/15">
              <div className="absolute -left-[7px] top-1.5 size-3 rounded-full bg-black/30" aria-hidden="true" />
              <h3 className="text-lg font-bold uppercase tracking-wider text-[#111111]">Handcrafted Excellence</h3>
              <p className="mt-4 text-xs sm:text-sm md:text-base leading-relaxed text-[#555555]">
