      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="mx-auto mt-3 max-w-7xl max-h-[85vh] overflow-y-auto rounded-3xl bg-white/95 backdrop-blur-2xl border border-black/10 p-6 sm:p-7 shadow-2xl md:hidden"
          >
