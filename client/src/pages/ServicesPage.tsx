      ...
      <div className="mx-auto max-w-[1360px] space-y-12 sm:space-y-16">
        ...
        <div className="bg-[#111111] text-[#F7F7F5] rounded-3xl p-7 sm:p-12 md:p-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 sm:gap-8 shadow-xl border border-white/10 relative overflow-hidden">
          <div className="space-y-2 z-10">
            <h2 className="text-xl sm:text-3xl font-bold font-sans text-white">Need a custom software platform?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full sm:w-auto">
            <button 
              ...
              className="btn-sheen group inline-flex min-h-12 sm:min-h-13 items-center justify-center gap-3 rounded-full bg-white px-7 sm:px-8 py-3.5 text-xs font-bold text-[#111111] shrink-0 hover:bg-[#F7F7F5] hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 uppercase tracking-wider shadow-lg hover:shadow-2xl hover:shadow-white/20 focus-visible:ring-2 focus-visible:ring-[#4F6B85] focus-visible:outline-none w-full sm:w-auto"
            >
