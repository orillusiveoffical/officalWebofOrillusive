  ...
  return (
    <div className="pt-28 sm:pt-36 pb-20 sm:pb-28 px-4 sm:px-8 lg:px-16 bg-[#F7F7F5] text-[#111111] min-h-screen font-sans">
      ...
      <StructuredData
        ...
        id="breadcrumb"
      />
      <div className="mx-auto max-w-[1360px] space-y-16 sm:space-y-24">
        
        {/* About Hero */}
        <div>
          <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#4F6B85] mb-3 sm:mb-4">Studio Philosophy</p>
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-sans font-bold leading-tight text-[#111111] max-w-5xl mb-4 sm:mb-6">
        ...
        <div className="border-t border-black/10 pt-12 sm:pt-16">
          <h2 className="text-xl sm:text-3xl font-bold font-sans text-[#111111] mb-8 sm:mb-12">Engineering Standards</h2>
          <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-black/10 shadow-xs">
              <span className="text-xs text-[#4F6B85] font-mono font-bold">01 // ARCHITECTURE</span>
              <h3 className="mt-4 sm:mt-5 text-lg sm:text-xl font-bold font-sans text-[#111111]">Modern Architecture</h3>
              <p className="mt-2.5 sm:mt-3 text-xs sm:text-sm leading-relaxed text-[#555555]">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-black/10 shadow-xs">
              ...
              <h3 className="mt-4 sm:mt-5 text-lg sm:text-xl font-bold font-sans text-[#111111]">Handcrafted UX</h3>
              <p className="mt-2.5 sm:mt-3 text-xs sm:text-sm leading-relaxed text-[#555555]">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-black/10 shadow-xs">
              ...
              <h3 className="mt-4 sm:mt-5 text-lg sm:text-xl font-bold font-sans text-[#111111]">Direct Senior Access</h3>
              <p className="mt-2.5 sm:mt-3 text-xs sm:text-sm leading-relaxed text-[#555555]">
